...
!include NazgulPkg/Device/$(TARGET_DEVICE)/Defines.dsc.inc
...
!include NazgulPkg/Device/$(TARGET_DEVICE)/DXE.dsc.inc

[LibraryClasses.common]
  # Move PlatformMemoryMapLib to Device/<device>/Library
  PlatformMemoryMapLib|NazgulPkg/Device/$(TARGET_DEVICE)/Library/PlatformMemoryMapLib/PlatformMemoryMapLib.inf

  # Move PlatformConfigurationMapLib to Device/<device>/Library
  PlatformConfigurationMapLib|NazgulPkg/Device/$(TARGET_DEVICE)/Library/PlatformConfigurationMapLib/PlatformConfigurationMapLib.inf
...
!include NazgulPkg/Device/$(TARGET_DEVICE)/PcdsFixedAtBuild.dsc.inc
